...
import TOTYpack from './image/22TOTYpack.png';
            ...
            {(() => {
                switch (true) {
                    case (num > 98.3329166585):
                        ...
                        return <Result profile={Son} reinforce={1} overall={108} position={"LM"} nation={Korea} name={"손흥민"} pay={25} />
                    case (num > 96.6658333259 && num <= 98.3329166585):
                        return <Result profile={Lewandowski} reinforce={1} overall={110} position={"ST"} nation={Poland} name={"R.레반도프스키"} pay={26} />
                    case (num > 94.9987499933 && num <= 96.6658333259):
                        return <Result profile={Mbappe} reinforce={1} overall={110} position={"ST"} nation={France} name={"킬리안 음바페"} pay={26} />
                    case (num > 89.9986666607 && num <= 94.9987499933):
                        return <Result profile={Messi} reinforce={1} overall={110} position={"RW"} nation={Argentina} name={"리오넬 메시"} pay={27} />
                    case (num > 84.9985833281 && num <= 89.9986666607):
                        return <Result profile={Dias} reinforce={1} overall={110} position={"CB"} nation={Portugal} name={"후벵 디아스"} pay={26} />
                    case (num > 79.9984999955 && num <= 84.9985833281):
                        return <Result profile={DeBruyne} reinforce={1} overall={109} position={"CM"} nation={Belgium} name={"케빈 더브라위너"} pay={26} />
                    case (num > 66.6654166629 && num <= 79.9984999955):
                        return <Result profile={Kante} reinforce={1} overall={109} position={"CDM"} nation={France} name={"은골로 캉테"} pay={24} />
                    case (num > 53.3323333303 && num <= 66.6654166629):
                        return <Result profile={Donnarumma} reinforce={1} overall={109} position={"GK"} nation={Italy} name={"잔루이지 돈나룸마"} pay={22} />
                    case (num > 39.9992499977 && num <= 53.3323333303):
                        return <Result profile={Jorginho} reinforce={1} overall={108} position={"CM"} nation={Italy} name={"조르지뉴"} pay={24} />
                    case (num > 26.6661666651 && num <= 39.9992499977):
                        return <Result profile={Marquinhos} reinforce={1} overall={108} position={"CB"} nation={Brazil} name={"마르키뉴스"} pay={25} />
                    case (num > 13.3330833325 && num <= 26.6661666651):
                        return <Result profile={Cancelo} reinforce={1} overall={108} position={"RB"} nation={Portugal} name={"주앙 칸셀루"} pay={23} />
                    case (num > 0 && num <= 13.3330833325):
                        return <Result profile={Hakimi} reinforce={1} overall={107} position={"RB"} nation={Morocco} name={"아슈라프 하키미"} pay={23} />
                    default:
                        return <PackDiv><img alt="" src={TOTYpack} /></PackDiv>
                }
            })()}
        </div>
    );
...
const PackDiv = styled.div`
    margin: 50px;
`
export default TOTYTopPriceAll;