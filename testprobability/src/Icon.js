            ...
            {(() => {
                switch (true) {
                    ...
                    case (num > 99.6434940905 && num <= 99.8217472106):
                        return <Result profile={Cha} name={"차범근"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 99.4652409704 && num <= 99.6434940905):
                        return <Result profile={Beckham} name={"데이비드 베컴"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 99.2869878503 && num <= 99.4652409704):
                        return <Result profile={Henry} name={"티에리 앙리"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 99.1087347302 && num <= 99.2869878503):
                        return <Result profile={Torres} name={"페르난도 토레스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 98.7522284901 && num <= 99.1087347302):
                        return <Result profile={Eto} name={"사뮈엘 에토"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 98.3957222500 && num <= 98.7522284901):
                        return <Result profile={Kaka} name={"카카"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 98.2174691299 && num <= 98.3957222500):
                        return <Result profile={VanPersie} name={"로빈 반페르시"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 97.8609628898 && num <= 98.2174691299):
                        return <Result profile={Park} name={"박지성"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 97.5044566497 && num <= 97.8609628898):
                        return <Result profile={Drogba} name={"디디에 드로그바"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 97.3262035296 && num <= 97.5044566497):
                        return <Result profile={Eusebio} name={"에우제비우"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 96.9696972895 && num <= 97.3262035296):
                        return <Result profile={Maldini} name={"파올로 말디니"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 96.6131910494 && num <= 96.9696972895):
                        return <Result profile={Rijkaard} name={"프랑크 레이카르트"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 96.4349379293 && num <= 96.6131910494):
                        return <Result profile={Zidane} name={"지네딘 지단"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 96.2566848092 && num <= 96.4349379293):
                        return <Result profile={Rooney} name={"웨인 루니"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 95.9001785691 && num <= 96.2566848092):
                        return <Result profile={Ronaldinho} name={"호나우지뉴"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 95.1871660890 && num <= 95.9001785691):
                        return <Result profile={Puskas} name={"페렌츠 푸스카스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 94.4741536089 && num <= 95.1871660890):
                        return <Result profile={Xavi} name={"차비"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 93.7611411288 && num <= 94.4741536089):
                        return <Result profile={Ballack} name={"미하엘 발락"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 93.0481286487 && num <= 93.7611411288):
                        return <Result profile={Nesta} name={"알레산드로 네스타"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 92.3351161686 && num <= 93.0481286487):
                        return <Result profile={Cantona} name={"에릭 칸토나"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 91.6221036885 && num <= 92.3351161686):
                        return <Result profile={Vieira} name={"파트리크 비에이라"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 90.9090912084 && num <= 91.6221036885):
                        return <Result profile={Nedved} name={"파벨 네드베드"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 90.1960787283 && num <= 90.9090912084):
                        return <Result profile={Schweinsteiger} name={"B.슈바인슈타이거"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 89.4830662482 && num <= 90.1960787283):
                        return <Result profile={Ferdinand} name={"리오 퍼디난드"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 88.7700537681 && num <= 89.4830662482):
                        return <Result profile={Vidic} name={"네마냐 비디치"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 88.0570412880 && num <= 88.7700537681):
                        return <Result profile={Scholes} name={"폴 스콜스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 87.3440288079 && num <= 88.0570412880):
                        return <Result profile={Pirlo} name={"안드레아 피를로"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 86.6310163278 && num <= 87.3440288079):
                        return <Result profile={Cruyff} name={"요한 크루이프"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 85.9180038477 && num <= 86.6310163278):
                        return <Result profile={Effenberg} name={"슈테판 에펜베르크"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 85.2049913676 && num <= 85.9180038477):
                        return <Result profile={Sanchez} name={"우고 산체스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 84.4919788875 && num <= 85.2049913676):
                        return <Result profile={Puyol} name={"카를레스 푸욜"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 83.7789664074 && num <= 84.4919788875):
                        return <Result profile={Essien} name={"마이클 에시앙"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 82.7094476873 && num <= 83.7789664074):
                        return <Result profile={Cafu} name={"카푸"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 81.6399289672 && num <= 82.7094476873):
                        return <Result profile={Yashin} name={"레프 야신"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 80.5704102471 && num <= 81.6399289672):
                        return <Result profile={Casillas} name={"카시야스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 79.5008915270 && num <= 80.5704102471):
                        return <Result profile={Baggio} name={"로베르토 바조"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 78.4313728069 && num <= 79.5008915270):
                        return <Result profile={Dalglish} name={"케니 달글리시"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 77.3618540868 && num <= 78.4313728069):
                        return <Result profile={Garrincha} name={"가린샤"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 76.2923353667 && num <= 77.3618540868):
                        return <Result profile={Crespo} name={"에르난 크레스포"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 75.2228166466 && num <= 76.2923353667):
                        return <Result profile={Hagi} name={"게오르게 하지"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 74.1532979265 && num <= 75.2228166466):
                        return <Result profile={Seedorf} name={"클라렌스 세이도르프"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 73.0837792064 && num <= 74.1532979265):
                        return <Result profile={Carlos} name={"호베르투 카를루스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 72.0142604863 && num <= 73.0837792064):
                        return <Result profile={RoyKeane} name={"로이 킨"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 70.5882355262 && num <= 72.0142604863):
                        return <Result profile={Owen} name={"마이클 오언"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 69.1622105661 && num <= 70.5882355262):
                        return <Result profile={Lahm} name={"필립 람"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 67.7361856060 && num <= 69.1622105661):
                        return <Result profile={DelPiero} name={"A.델피에로"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 66.3101606459 && num <= 67.7361856060):
                        return <Result profile={Bergkamp} name={"데니스 베르캄프"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 64.8841356858 && num <= 66.3101606459):
                        return <Result profile={Desailly} name={"마르셀 드사이"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 63.4581107257 && num <= 64.8841356858):
                        return <Result profile={Cannavaro} name={"파비오 칸나바로"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 62.0320857656 && num <= 63.4581107257):
                        return <Result profile={Raul} name={"라울"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 60.6060608055 && num <= 62.0320857656):
                        return <Result profile={Alberto} name={"카를루스 아우베르투"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 59.1800358454 && num <= 60.6060608055):
                        return <Result profile={Lampard} name={"프랭크 램파드"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 57.7540108853 && num <= 59.1800358454):
                        return <Result profile={Rivaldo} name={"히바우두"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 56.3279859252 && num <= 57.7540108853):
                        return <Result profile={Overmars} name={"M.오베르마르스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 54.9019609651 && num <= 56.3279859252):
                        return <Result profile={Blanc} name={"로랑 블랑"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 53.4759360050 && num <= 54.9019609651):
                        return <Result profile={Gerrard} name={"스티븐 제라드"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 52.0499110449 && num <= 53.4759360050):
                        return <Result profile={Petit} name={"에마뉘엘 프티"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 50.6238860848 && num <= 52.0499110449):
                        return <Result profile={Kluivert} name={"P.클라위베르트"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 49.1978611247 && num <= 50.6238860848):
                        return <Result profile={Butragueno} name={"부트라게뇨"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 47.7718361646 && num <= 49.1978611247):
                        return <Result profile={Riquelme} name={"리켈메"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 46.3458112045 && num <= 47.7718361646):
                        return <Result profile={Inzaghi} name={"필리포 인자기"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 44.9197862444 && num <= 46.3458112045):
                        return <Result profile={Hierro} name={"페르난도 이에로"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 43.4937612843 && num <= 44.9197862444):
                        return <Result profile={Zanetti} name={"하비에르 사네티"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 42.0677363242 && num <= 43.4937612843):
                        return <Result profile={Makelele} name={"클로드 마켈렐레"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 40.6417113641 && num <= 42.0677363242):
                        return <Result profile={Larsson} name={"헨릭 라르손"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 39.2156864040 && num <= 40.6417113641):
                        return <Result profile={Cech} name={"페트르 체흐"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 37.7896614439 && num <= 39.2156864040):
                        return <Result profile={Campbell} name={"솔 캠벨"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 36.3636364838 && num <= 37.7896614439):
                        return <Result profile={Stoitchkov} name={"H.스토이치코프"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 34.9376115237 && num <= 36.3636364838):
                        return <Result profile={Lineker} name={"게리 리네커"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 33.5115865636 && num <= 34.9376115237):
                        return <Result profile={Schmeichel} name={"페터 슈마이켈"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 32.0855616035 && num <= 33.5115865636):
                        return <Result profile={Koeman} name={"로날트 쿠만"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 30.6595366434 && num <= 32.0855616035):
                        return <Result profile={Rush} name={"이언 러시"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 29.2335116833 && num <= 30.6595366434):
                        return <Result profile={VanDersar} name={"에드윈 반데르사르"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 27.8074867232 && num <= 29.2335116833):
                        return <Result profile={Vieri} name={"크리스티안 비에리"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 26.7379680031 && num <= 27.8074867232):
                        return <Result profile={RuiCosta} name={"후이 코스타"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 25.6684492830 && num <= 26.7379680031):
                        return <Result profile={Trezeguet} name={"다비드 트레제게"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 24.5989305629 && num <= 25.6684492830):
                        return <Result profile={Deco} name={"데쿠"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 23.5294118428 && num <= 24.5989305629):
                        return <Result profile={Zambrotta} name={"잔루카 잠브로타"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 22.4598931227 && num <= 23.5294118428):
                        return <Result profile={Gattuso} name={"젠나로 가투소"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 21.3903744026 && num <= 22.4598931227):
                        return <Result profile={Socrates} name={"소크라테스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 20.3208556825 && num <= 21.3903744026):
                        return <Result profile={Guardiola} name={"과르디올라"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 19.2513369624 && num <= 20.3208556825):
                        return <Result profile={Veron} name={"베론"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 18.1818182423 && num <= 19.2513369624):
                        return <Result profile={MLaudrup} name={"미카엘 라우드루프"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 17.1122995222 && num <= 18.1818182423):
                        return <Result profile={Wright} name={"이언 라이트"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 16.0427808021 && num <= 17.1122995222):
                        return <Result profile={Pires} name={"로베르 피레스"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    case (num > 14.9732620820 && num <= 16.0427808021):
                        return <Result profile={Ljungberg} name={"프레디 융베리"} reinforce={1} overall={111} position={"LW"} nation={Brazil} pay={26} price={69_000_000_000} />
                    // ============================================================================================================================================= //
